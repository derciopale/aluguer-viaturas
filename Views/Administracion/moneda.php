            ...
            <form id="formulario" onsubmit="registrarMoneda(event);" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="alert alert-info d-flex align-items-center" role="alert">
                        ...
                        <div>
                        Todos os campos sao obrigatorios<span class="text-danger fw-bold">*</span>
                        </div>
                    </div>
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El símbolo es requerido">
                        <input id="simbolo" class="form-control" type="text" name="simbolo" placeholder="Simbolo de la moneda" required>
                        <label for="simbolo">Simbolo <span class="text-danger fw-bold">*</span></label>
                    </div>
                    <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El nombre es requerido">
                        <input type="hidden" id="id" name="id">
                        <input id="nombre" class="form-control" type="text" name="nombre" placeholder="Nombre del Moneda" required>
