    ...
    <div class="col-lg-5 col-md-5 col-sm-12">
        <div class="card profile-card-3">
            ...
            <div class="card-content">
                ...
                <strong><i class="fas fa-list"></i> Apelido: </strong> <?php echo $data['apellido']; ?><br>
                <strong><i class="fas fa-envelope"></i> Email: </strong> <?php echo $data['correo']; ?><br>
                <strong><i class="fas fa-phone"></i> Telefone: </strong> <?php echo $data['telefono']; ?><br>
                <strong><i class="fas fa-home"></i> Endereço: </strong> <?php echo $data['direccion']; ?><br>
                <strong><i class="fas fa-calendar"></i> Data de Registo: </strong> <?php echo $data['fecha']; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-floating mb-3">
                                ...
                                <label for="telefono"><i class="fas fa-phone"></i> Telefone</label>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-floating mb-3">
                                ...
                                <label for="direccion"><i class="fas fa-home"></i> Endereço</label>
                            </div>
            ...
            <div class="card-body text-center">
                <form id="frmCambiarPass" onsubmit="frmCambiarPass(event);">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input id="clave_actual" class="form-control" type="password" name="clave_actual" placeholder="Senha Actual" required>
                                <label for="clave_actual"><i class="fas fa-key"></i> Senha Actual</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input id="clave_nueva" class="form-control" type="password" name="clave_nueva" placeholder="Senha Nueva" required>
                                <label for="clave_nueva"><i class="fas fa-lock"></i> Senha Nova</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input id="confirmar_clave" class="form-control" type="password" name="confirmar_clave" placeholder="Confirmar Senha" required>
                                <label for="confirmar_clave"><i class="fas fa-unlock"></i> Confirmar Senha</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-grid gap-2 mt-2">
