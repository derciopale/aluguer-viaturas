...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?php echo base_url; ?>Administracion/home">Moz Aluger</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="<?php echo base_url; ?>Usuarios/salir">Encerrar sessão</a></li>
                </ul>
            </li>
        </ul>
    </nav>
                        ...
                        <?php if ($_SESSION['id_usuario'] == 1) { ?>
                            ...
                            <div class="collapse" id="collapseVehiculos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo base_url; ?>Vehiculos">Veiculos</a>
                                </nav>
                            </div>
                        <?php } ?>
